...
## analysis using the complete tree with propotto moved to match Gunnell

setwd("Biogeography/Propotto_effect/")
trfn<-"Propotto_move_nozero.tre"
tr <- read.tree(trfn)
geogfn = "allTaxa.phy"
...
# PDF plots
#######################################################
pdffn = "Primates_DEC_vs_DEC+J_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=12)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on primates w propotto moved"
...
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), 
                                plotwhat="text", label.offset=0.2, tipcex=0.3, statecex=0.3, 
                                splitcex=0.3, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, 
...
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), 
                         plotwhat="pie", label.offset=0.2, tipcex=0.3, statecex=0.3, 
                         splitcex=0.3, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, 
                         include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Primates"
...
res1 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, 
                                addl_params=list("j"), plotwhat="text", label.offset=0.2, tipcex=0.3, 
                                statecex=0.3, splitcex=0.3, titlecex=0.8, plotsplits=TRUE, 
